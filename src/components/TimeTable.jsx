                ...
                <div className="w-full bg-zinc-900 rounded-xl shadow-2xl shadow-white/5 p-4 sm:p-6 md:p-8 border border-white/10">
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <motion.div
                            ...
                            initial={{ x: 0 }}
                            animate={{ x: step === 2 ? -50 : 0, opacity: step === 2 ? 0 : 1 }}
                            ...
                            {step === 2 && (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="w-full sm:w-[60%] mx-auto bg-white text-black font-medium py-3 px-4 rounded-lg transition-all duration-300 hover:bg-zinc-100 active:bg-zinc-200 hover:scale-[1.02] flex items-center justify-center gap-2 cursor-pointer mb-6"
                                    >
                                        <PlusCircle className="h-5 w-5" /> Create Subject
                                    </button>

                                    {/* Subject Input Form */}
                                    <div className={`flex flex-col gap-y-4 overflow-hidden transition-all duration-300 ${isSubjectOpen ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'}`}>
                                        {/* Subject Name Input */}
                                        <div className="space-y-2 w-full sm:w-1/2 mx-auto">
