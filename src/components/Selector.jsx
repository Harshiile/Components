          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative p-1.5 bg-zinc-800 rounded-full flex shadow-inner w-full">
                ...
                {breakDurationsArray.map(item => (
                  <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-full text-sm font-medium relative z-10 transition-colors duration-300 cursor-pointer ${breakDuration === item ? 'text-black' : 'text-white/70 hover:text-white'}`}
                  >
                    {item} mins
                  </button>
                ))}
              ...
              <button
                ...
                className="w-[60%] my-6 mx-auto bg-white text-black font-medium py-3 px-4 rounded-lg transition-all duration-300 hover:bg-zinc-100 active:bg-zinc-200 hover:scale-[1.02] flex items-center justify-center gap-2 cursor-pointer"
              >
